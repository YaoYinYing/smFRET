...
; Hazen 3/00
;
; Cy3 0-169; Cy5 171-340; Cy7 342-511
;

pro p_nxgn1_ffp_3ch, run
...
print, ""
openr, 1, "C:\Users\Ha-Myong\Documents\tir data\rough_35.map"
...
print, ""
openr, 1, "C:\Users\Ha-Myong\Documents\tir data\rough_37.map"
...
good = fltarr(2,4000)
back = fltarr(4000)
; back2 = fltarr(4000) ; no ALEX, one blank
foob = bytarr(7,7)
diff = fltarr(3,3)

no_good = 0

for i = 15, 154 do begin
    for j = 15, 496 do begin
         ...
         if x eq 0 then begin
          if y eq 0 then begin
              ...
              if quality eq 1 then begin
                 ...
                 back(no_good) = 0
                 ; back2(no_good) = 0 ; no ALEX, one blank
                 no_good = no_good + 1
                 good(0,no_good) = xf
                 good(1,no_good) = yf
                 back(no_good) = 0
